...
public class TestReturnStrings {
    public ListOfBestMatches positiveMatches(){
        String json = "{\n" +
                "    \"bestMatches\": [\n" +
                "        {\n" +
                "            \"1. symbol\": \"IBM\",\n" +
        ...
        return gson.fromJson(json, ListOfBestMatches.class);
    }

    public ListOfBestMatches noBestMatches(){
        String json = "{\n" +
                "    \"bestMatches\": []\n" +
                "}\n";
    ...
    public ListOfBestMatches negativeMatches(){
        String json = "{\n" +
    ...
    public CompanyOverView companyOverView(String symbol) {
        ...
        return gson.fromJson(json, CompanyOverView.class);
    }
    public CompanyOverView companyOverviewNoSymbol(){
        String json = "{\n" +
                "    \"Error Message\": \"Invalid API call. Please retry or visit the documentation (https://www.alphavantage.co/documentation/) for OVERVIEW.\"\n" +
                "}\n";
        Gson gson = new Gson();

        return gson.fromJson(json, CompanyOverView.class);
    }
    public CashFlowReports cashflowReportsNoSymbol() {
        String json = "{\n" +
                "    \"Error Message\": \"Invalid API call. Please retry or visit the documentation (https://www.alphavantage.co/documentation/) for OVERVIEW.\"\n" +
                "}\n";
        Gson gson = new Gson();
        return gson.fromJson(json,CashFlowReports.class);
    ...
    public ArrayList<String> DatabaseInfo(){
        ArrayList<String> info = new ArrayList<>();

        info.add("IBM");
        info.add("International Business Machines Corporation");
