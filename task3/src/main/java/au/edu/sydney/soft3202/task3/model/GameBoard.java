...
public class GameBoard {
    ...
    public void insertGameSave(int user_id, String saveName, String saveData){
        database.insertGameSave(user_id, saveName, saveData);
    }
    public void deleteGameSave(int user_id, String saveName){
        database.deleteGameSave(user_id, saveName);
    }
    public void insertUser(int user_id, String name){
        database.insertUser(user_id, name);
    }

    public Boolean checkUsername(String name){
        return  database.getUsers(name);
    }

    public ArrayList<String> getSaveDataNames(String username){
        return database.getListOfUserSaves(username);
    }

    public String getSaveData(String saveName, Integer user_id){
        return database.getSaveData(saveName, user_id);
    }
